-- Drop and recreate rolling_memory_overview to remove security_invoker/security definer flags.
-- Using a fresh timestamped migration ensures Supabase applies the change.

DROP VIEW IF EXISTS public.rolling_memory_overview;

CREATE VIEW public.rolling_memory_overview AS
SELECT 
