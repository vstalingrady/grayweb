...
users = sqlalchemy.Table(
    ...
    sqlalchemy.Column("supermemory_auto_recall", sqlalchemy.Boolean, nullable=True),
    sqlalchemy.Column("supermemory_auto_capture", sqlalchemy.Boolean, nullable=True),
    sqlalchemy.Column("supermemory_capture_mode", sqlalchemy.String, nullable=True),
    sqlalchemy.Column("supermemory_max_recall_results", sqlalchemy.Integer, nullable=True),
    sqlalchemy.Column("supermemory_profile_frequency", sqlalchemy.Integer, nullable=True),
...
transactions = sqlalchemy.Table(
    ...
    sqlalchemy.Column("paid_at", sqlalchemy.DateTime, nullable=True),
