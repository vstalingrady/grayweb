...
_USER_COLUMNS = [
    ...
    ("supermemory_auto_recall", "BOOLEAN", None),
    ("supermemory_auto_capture", "BOOLEAN", None),
    ("supermemory_capture_mode", "TEXT", None),
    ("supermemory_max_recall_results", "INTEGER", None),
    ("supermemory_profile_frequency", "INTEGER", None),
]
...
def run_startup_migrations():
    ...
    _ensure_sqlite_table("proactivity_delivery_guard", """
        CREATE TABLE proactivity_delivery_guard (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            user_id INTEGER NOT NULL,
