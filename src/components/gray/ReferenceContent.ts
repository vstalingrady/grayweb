export const MARKDOWN_CONTENT = String.raw`# Gemini API File Search Documentation
...
curl "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent" \\
    ...
    -X POST \\
    -d '{
            "contents": [{"parts":[{"text": "What does the research say about ..."}]}],
            "tools": [{"file_search": { "file_search_store_names":["'$STORE_NAME'"], "metadata_filter": "author = \\"Robert Graves\\"" }}
            ]
...
curl "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=\${GEMINI_API_KEY}" \\
    ...
    -X POST \\
    -d '{
            "contents": [{"parts":[{"text": "Tell me about the book I, Claudius"}]}],
            "tools": [
                {
                    "file_search": { 
...
(See documentation for full list of text file types)
