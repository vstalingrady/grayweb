      ...
      <article className="legal-shell legal-article">
        <div className="legal-article__content">
          <section className="legal-hero">
            ...
            <p>
              This notice explains how we collect, use, and safeguard information when you interact with the Alignment Gray
              workspace (the "Service"). By using the Service, you agree to the practices described below.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <BulletList
              items={[
                ...
                "Generate AI responses using Gray's locally managed models so your prompts stay inside the workspace.",
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:privacy@alignmentid.com">privacy@alignmentid.com</a>. You can also review additional project
              details on the <Link href="https://github.com/alignmentid/gray">Alignment Gray repository</Link>.
            </p>
          </section>
        </div>
      </article>
