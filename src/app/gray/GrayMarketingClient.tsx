        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              >
                Gray is the proactive AI mentor that checks in throughout your day, remembers everything about your life, and helps you become who you're capable of being.
              </motion.p>
              ...
              >
                ...
                <Link 
                  href="#how-it-works" 
                  className="w-full sm:w-auto px-8 py-4 bg-zinc-900 text-white border border-zinc-800 font-medium rounded-full hover:bg-zinc-800 transition-colors"
                >
                  See How It Works
                </Link>
              </motion.div>
