        ...
        headers: [
          ...
          // Note: 'unsafe-inline' required for Next.js styles, 'unsafe-eval' for react-three-fiber
          {
            ...
            value: [
              ...
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://static.cloudflareinsights.com https://challenges.cloudflare.com https://api.midtrans.com https://api.sandbox.midtrans.com https://app.midtrans.com https://simulator.sandbox.midtrans.com https://gray.alignment.id",
              // Styles: self + Google Fonts
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              // Images: self + trusted sources
              "img-src 'self' blob: data: https://*.supabase.co https://*.googleusercontent.com https://*.gstatic.com https://www.google.com https://avatars.githubusercontent.com https://*.githubusercontent.com https://cdn.discordapp.com https://secure.gravatar.com https://www.gravatar.com https://api.midtrans.com https://api.sandbox.midtrans.com https://i.ytimg.com https://*.ytimg.com https://s.wordpress.com https://s0.wp.com https://i0.wp.com",
