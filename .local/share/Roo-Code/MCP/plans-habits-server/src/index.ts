...
type ListPlansInput = z.infer<typeof ListPlansArgs>;
type CreatePlanInput = z.infer<typeof CreatePlanArgs>;
type ListHabitsInput = z.infer<typeof ListHabitsArgs>;
type CreateHabitInput = z.infer<typeof CreateHabitArgs>;
type UpdatePlanInput = z.infer<typeof UpdatePlanArgs>;
type DeletePlanInput = z.infer<typeof DeletePlanArgs>;
type UpdateHabitInput = z.infer<typeof UpdateHabitArgs>;
type DeleteHabitInput = z.infer<typeof DeleteHabitArgs>;
type ListRemindersInput = z.infer<typeof ListRemindersArgs>;
type CreateReminderInput = z.infer<typeof CreateReminderArgs>;
type UpdateReminderInput = z.infer<typeof UpdateReminderArgs>;
type DeleteReminderInput = z.infer<typeof DeleteReminderArgs>;
  ...
  server.setRequestHandler(
    ...
    async (req: {
      ...
      switch (name) {
        ...
        case "list_plans": {
          const parsed: ListPlansInput = ListPlansArgs.parse(args);
            ...
            content: [
              {
                type: "text",
                text: JSON.stringify(
                  { user_id: parsed.user_id, plans: plans ?? [] },
                  null,
                  2
                ),
              },
        ...
        case "create_plan": {
          const parsed: CreatePlanInput = CreatePlanArgs.parse(args);
          const payload = {
            label: parsed.label,
            ...
            content: [
              {
                type: "text",
                text: JSON.stringify(
                  { user_id: parsed.user_id, plan: created },
                  null,
                  2
                ),
              },
        ...
        case "update_plan": {
          const parsed: UpdatePlanInput = UpdatePlanArgs.parse(args);
          ...
          if (parsed.deadline !== undefined) payload.deadline = parsed.deadline;
          ...
          const updated = await backendFetch(
            `/users/${parsed.user_id}/plans/${parsed.plan_id}`,
            {
              method: "PATCH",
              body: JSON.stringify(payload),
            }
            ...
            content: [
              {
                type: "text",
                text: JSON.stringify(
                  { user_id: parsed.user_id, plan: updated },
                  null,
                  2
                ),
              },
        ...
        case "delete_plan": {
          const parsed: DeletePlanInput = DeletePlanArgs.parse(args);
          await backendFetch(
            `/users/${parsed.user_id}/plans/${parsed.plan_id}`,
            {
              method: "DELETE",
        ...
        case "list_habits": {
          const parsed: ListHabitsInput = ListHabitsArgs.parse(args);
          const habits = await backendFetch(
            `/users/${parsed.user_id}/habits`,
            {
              method: "GET",
            }
          );
            ...
            content: [
              {
                type: "text",
                text: JSON.stringify(
                  { user_id: parsed.user_id, habits: habits ?? [] },
                  null,
                  2
                ),
              },
        ...
        case "create_habit": {
          const parsed: CreateHabitInput = CreateHabitArgs.parse(args);
          const payload: Record<string, unknown> = {
            label: parsed.label,
          };
          if (parsed.streak_label) payload.streak_label = parsed.streak_label;
            ...
            content: [
              {
                type: "text",
                text: JSON.stringify(
                  { user_id: parsed.user_id, habit: created },
                  null,
                  2
                ),
              },
        ...
        case "update_habit": {
          const parsed: UpdateHabitInput = UpdateHabitArgs.parse(args);
          const payload: Record<string, unknown> = {};
          if (parsed.label !== undefined) payload.label = parsed.label;
          ...
          const habit = await backendFetch(
            `/users/${parsed.user_id}/habits/${parsed.habit_id}`,
            {
              method: "PATCH",
              body: JSON.stringify(payload),
            }
        ...
        case "delete_habit": {
          const parsed: DeleteHabitInput = DeleteHabitArgs.parse(args);
          await backendFetch(
            `/users/${parsed.user_id}/habits/${parsed.habit_id}`,
            {
              method: "DELETE",
        ...
        case "list_reminders": {
          const parsed: ListRemindersInput = ListRemindersArgs.parse(args);
          const queryParams = new URLSearchParams();
          if (parsed.status) queryParams.set("status_filter", parsed.status);
          if (parsed.limit) queryParams.set("limit", String(parsed.limit));
          const query = queryParams.toString();
          const reminders = await backendFetch(
            `/users/${parsed.user_id}/reminders${query ? `?${query}` : ""}`,
            { method: "GET" }
          );
          return {
            content: [
              {
                type: "text",
                text: JSON.stringify(
                  { user_id: parsed.user_id, reminders: reminders ?? [] },
                  null,
                  2
                ),
              },
        ...
        case "create_reminder": {
          const parsed: CreateReminderInput = CreateReminderArgs.parse(args);
          const payload: Record<string, unknown> = {
            label: parsed.label,
          ...
          if (parsed.description !== undefined)
            payload.description = parsed.description;
          if (parsed.entity_type) payload.entity_type = parsed.entity_type;
          if (parsed.entity_id) payload.entity_id = parsed.entity_id;
          if (parsed.metadata) payload.metadata = parsed.metadata;

          const reminder = await backendFetch(
            `/users/${parsed.user_id}/reminders`,
            {
              method: "POST",
              body: JSON.stringify(payload),
            }
            ...
            content: [
              {
                type: "text",
                text: JSON.stringify(
                  { user_id: parsed.user_id, reminder },
                  null,
                  2
                ),
              },
        ...
        case "update_reminder": {
          const parsed: UpdateReminderInput = UpdateReminderArgs.parse(args);
          const payload: Record<string, unknown> = {};
          if (parsed.label !== undefined) payload.label = parsed.label;
          if (parsed.description !== undefined)
            payload.description = parsed.description;
          ...
          const reminder = await backendFetch(
            `/users/${parsed.user_id}/reminders/${parsed.reminder_id}`,
            {
              method: "PATCH",
              body: JSON.stringify(payload),
            }
        ...
        case "delete_reminder": {
          const parsed: DeleteReminderInput = DeleteReminderArgs.parse(args);
          await backendFetch(
            `/users/${parsed.user_id}/reminders/${parsed.reminder_id}`,
            {
              method: "DELETE",
