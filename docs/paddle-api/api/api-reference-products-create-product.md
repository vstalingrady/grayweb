# Create a product - Paddle Developer

**Source:** https://developer.paddle.com/api-reference/products/create-product
...
[Create a product](/api-reference/products/create-product#create-a-product)
...
[Request Body](/api-reference/products/create-product#request-body)
...
[Response](/api-reference/products/create-product#response)
...
*Last scraped: 2025-12-15 20:25:13*
