...
**Source:** https://developer.paddle.com/paddlejs/methods/paddle-spinner-show
...
[Paddle.Spinner.show()](/paddlejs/methods/paddle-spinner-show#paddle.spinner.show())

Shows a loading spinner.


UsePaddle.Spinner.show()to show a loading spinner. The spinner appears full screen on a darkened background.
...
Typically paired withthePaddle.Spinner.hide()methodwhen loading an inline checkout in response to an event.

[thePaddle.Spinner.hide()method](/paddlejs/methods/paddle-spinner-hide)

## Example

[Example](/paddlejs/methods/paddle-spinner-show#examples)

This example shows howPaddle.Spinner.show()can be called as part of an open checkout function.
...
[Related pages](/paddlejs/methods/paddle-spinner-show#related-pages)
[Read more](/paddlejs/methods/paddle-spinner-hide)
...
*Last scraped: 2025-12-15 20:20:19*
