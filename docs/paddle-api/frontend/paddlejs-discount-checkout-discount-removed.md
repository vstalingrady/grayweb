# checkout.discount.removed - Paddle Developer

**Source:** https://developer.paddle.com/paddlejs/discount/checkout-discount-removed
...
- Customer
- Payment
- Discountcheckout.discount.appliedcheckout.discount.removed
...
[checkout.discount.removed](/paddlejs/discount/checkout-discount-removed#checkout.discount.removed)

Emitted when a discount is removed from a checkout.
...
2  "name": "checkout.discount.removed",
3  "data": {
...
*Last scraped: 2025-12-15 20:20:49*
