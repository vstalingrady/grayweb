# transaction.billed - Paddle Developer

**Source:** https://developer.paddle.com/webhooks/transactions/transaction-billed
...
[transaction.billed](/webhooks/transactions/transaction-billed#transaction.billed)

Occurs when a transaction is billed. Itsstatusfield changes tobilledandbilled_atis populated.


Marking a transaction as billed is typically used when working with manually-collected transactions to issue aninvoice. It's not typically part of checkout workflows, where collection mode is automatic.


Transactions are marked as billed when:

- You update its status tobilledusing the API.
...
transaction.updatedevents occur immediately after to add:

[transaction.updated](/webhooks/transactions/transaction-updated)
- invoice_number, andinvoice_idif not already present.
- If manually-collected, the newly createdsubscription_idfor any recurring items.
...
2  "event_id": "evt_01hv8xqmb9e8y66q4hb54cfsf9",
3  "event_type": "transaction.billed",
4  "occurred_at": "2024-04-12T10:30:27.945096Z",
5  "notification_id": "ntf_01hv8xqmdrrnsp7rvaf1264cp2",
6  "data": {
...
*Last scraped: 2025-12-15 20:13:55*
