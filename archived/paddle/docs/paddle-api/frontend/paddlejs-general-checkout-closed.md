# checkout.closed - Paddle Developer

**Source:** https://developer.paddle.com/paddlejs/general/checkout-closed
...
[checkout.closed](/paddlejs/general/checkout-closed#checkout.closed)

Emitted when a checkout is closed. This typically means the customer clicked the close icon on an overlay checkout.


checkout.completedis emitted when payment is successful.
...
2  "name": "checkout.closed",
3  "data": {
4    "id": "che_01k9ppmn2hxp1z8nt5t8a5y6c1",
5    "transaction_id": "txn_01k9ppmmta091s41je23hwk1ba",
6    "status": "draft",
7    "custom_data": null,
8    "currency_code": "USD",
9    "customer": {
...
*Last scraped: 2025-12-15 20:20:54*
