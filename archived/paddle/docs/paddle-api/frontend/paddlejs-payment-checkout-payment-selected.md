# checkout.payment.selected - Paddle Developer

**Source:** https://developer.paddle.com/paddlejs/payment/checkout-payment-selected
...
[checkout.payment.selected](/paddlejs/payment/checkout-payment-selected#checkout.payment.selected)

Emitted when a payment method is selected.


This means a customer has selected one of the payment method buttons, like PayPal or Apple Pay, or started to enter details into the card details form.
...
2  "name": "checkout.payment.selected",
3  "data": {
...
*Last scraped: 2025-12-15 20:20:45*
