# checkout.payment.initiated - Paddle Developer

**Source:** https://developer.paddle.com/paddlejs/payment/checkout-payment-initiated
...
[checkout.payment.initiated](/paddlejs/payment/checkout-payment-initiated#checkout.payment.initiated)

Emitted when an attempt to take payment is initiated. Followed by either:

- checkout.payment.failedif payment fails
- checkout.completedif payment is successful

Typically used to track payment acceptance rates.
...
2  "name": "checkout.payment.initiated",
3  "data": {
...
8    "currency_code": "USD",
9    "customer": {
10      "id": "ctm_01k9pq1gzbza1n86n4jef18sbp",
11      "email": "sam@example.com",
12      "address": {
13        "postal_code": "10021",
14        "region": "",
15        "country_code": "US",
16        "id": "add_01k9pq6e149abgqb42rsebvvfw",
17        "city": "",
18        "first_line": ""
19      },
20      "business": null
...
*Last scraped: 2025-12-15 20:20:44*
